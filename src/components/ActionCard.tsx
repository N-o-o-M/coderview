...
function ActionCard({
  ...
  return (
    <Card
      className="group relative overflow-hidden hover:border-primary/50 transition-all duration-300 hover:shadow-lg cursor-pointer transition-transform duration-300 hover:scale-105"
      onClick={onClick}
    >
      {/* ACTION GRADIENT */}
      <div
